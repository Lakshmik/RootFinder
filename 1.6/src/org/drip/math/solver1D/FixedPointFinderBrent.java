...
public class FixedPointFinderBrent extends org.drip.math.solver1D.FixedPointFinderBracketing {
		...
		throws java.lang.Exception
	{
		...
		if (java.lang.Double.isNaN (_dblVariateIterativeShift) || _visp.getRobustVariateIteratorPrimitive()
			== _iIteratorPrimitive) {
		...
		if (!java.lang.Double.isNaN (_dblPreviousVariateIterativeShift) && (dblVariateEstimateShift <
			_visp.getRelativeVariateShift() * _dblPreviousVariateIterativeShift &&
