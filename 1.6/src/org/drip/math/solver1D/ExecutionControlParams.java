...
public class ExecutionControlParams {
	...
	public ExecutionControlParams()
	{
		...
		_dblAbsoluteOFToleranceFallback = 1.0e-06;
	}
		...
		throws java.lang.Exception
	{
		if (!org.drip.math.common.NumberUtil.IsValid (_dblOFGoalToleranceFactor = dblOFGoalToleranceFactor)
			|| !org.drip.math.common.NumberUtil.IsValid (_dblAbsoluteOFToleranceFallback =
				dblAbsoluteOFToleranceFallback) || 0 >= (_iNumIterations = iNumIterations))
			throw new java.lang.Exception ("ExecutionControlParams1D constructor: Invalid inputs");
	}
