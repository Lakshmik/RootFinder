...
public class RootFinderSample {
		...
		final java.lang.String[] astrArgs)
	{
		...
		org.drip.math.autodiff.ObjectiveFunction of = new org.drip.math.autodiff.ObjectiveFunction (null) {
			...
			@Override public org.drip.math.autodiff.Differential calcDerivative (
				final double dblVariate,
				...
				final int iOrder)
			{
				...
				if (1 != iOrder) {
					try {
						return new org.drip.math.autodiff.Differential (dblVariateInfinitesimal, (-1. *
